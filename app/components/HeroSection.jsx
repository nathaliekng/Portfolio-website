      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
            I'm a passionate Software Engineer dedicated to building and
            continous learning.
          </p>
          <div>
            <Link
            ...
            <DownloadButton
              file="NathalieNg_Resume.pdf"
              downloadName="NathalieNg_Resume"
            />
            {/* <Link
              href="NathalieNg_Resume.pdf" target="_blank"
        ...
        >
          <div className="rounded-full bg-[#181818] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] relative">
            <Image
              ...
              className="rounded-full w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] object-cover"
              width={300}
              height={300}
            />
          </div>
